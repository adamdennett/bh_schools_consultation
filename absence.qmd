...
-   The slope for Brighton is steeper than the slopes for schools grouped by all levels of Ofsted rating. However, looking at the slope and the points that are influencing it, it is clear that

    -   the distribution of the points means the line is not a very reliable summary (it's a poor model for Brighton and likely statistically insignificant)
...
-   Insert council data and plots up to 2030 here
