...
```{r, h3-setup warning=FALSE, message=FALSE, echo=FALSE}
...
ggplot(bn_pcds_sch_travel) +
  geom_histogram(aes(x = first_closest_time, fill = "First Closest Time"), binwidth = 2, alpha = 0.5, position = "identity", color = "black") +
  geom_histogram(aes(x = second_closest_time, fill = "Second Closest Time"), binwidth = 2, alpha = 0.5, position = "identity", color = "black") +
  geom_histogram(aes(x = third_closest_time, fill = "Third Closest Time"), binwidth = 2, alpha = 0.5, position = "identity", color = "black") +
