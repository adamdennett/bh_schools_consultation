...
dbWriteTable(con, name="pcds_2_longhill_walk_bus", value=pcds_2_longhill, overwrite=TRUE) #pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_baca_walk_bus", value=pcds_2_baca, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_varndean_walk_bus", value=pcds_2_varndean, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_ds_walk_bus", value=pcds_2_ds, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_patcham_walk_bus", value=pcds_2_patcham, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_cardinal_n_walk_bus", value=pcds_2_cardinal_n, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_blatchington_walk_bus", value=pcds_2_blatchington, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_hove_park_walk_bus", value=pcds_2_hove_park, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_kings_walk_bus", value=pcds_2_kings, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
...
dbWriteTable(con, name="pcds_2_paca_walk_bus", value=pcds_2_paca, overwrite=TRUE)#pcds_closest_1["id"] = as.integer(pcds_closest_1$id)
